...
export function PeopleItemPage() {
  ...
  const fetchPeopleItemRequest = useAppSelector(
    (state) => state.people.fetchPeopleItemRequest,
  );
      ...
      <>
        {fetchPeopleItemRequest.data && id && (
          <>
            ...
            <PeopleItemCardForPeopleItemPage
              peopleItem={fetchPeopleItemRequest.data}
              id={id}
            />
          </>
        )}
