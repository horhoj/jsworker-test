...
export function ListOfPeoplePage() {
  ...
  const listOfPeopleRequest = useAppSelector(
    (state) => state.people.fetchListOfPeopleRequest,
  );
  const fetchListOfPeopleRequest = useAppSelector(
    (state) => state.people.fetchListOfPeopleRequest,
  );
